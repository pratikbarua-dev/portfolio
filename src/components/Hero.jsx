    ...
    >
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center z-10">
        ...
        <div className="flex flex-col items-start text-left">
          ...
          <h1
            ref={headingRef}
            className="text-[28px] sm:text-[36px] md:text-[42px] lg:text-[48px] xl:text-[56px] font-black text-white leading-[1.15] tracking-tight uppercase select-none"
          >
            <span className="block">I BUILD <span className="text-primary font-mono select-all">SYSTEMS</span></span>
            <span
              className="text-primary font-mono block whitespace-nowrap min-h-[1.2em] mt-1"
              aria-live="polite"
            >
              {currentText}
              <motion.span
        ...
        <div className="relative flex justify-center items-center w-full max-w-[480px] mx-auto lg:max-w-[560px] xl:max-w-[620px] lg:h-full select-none lg:-mr-8">
          <div
            ref={imageRef}
